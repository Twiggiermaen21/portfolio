    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <motion.h3
                ...
                Hi! I'm Kacper <Image src={assets.hand_icon} alt='' className='w-6' />
            </motion.h3>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                <motion.a
                    ...
                    href="#contact" className='px-10 py-3 border border-white rounded-full bg-MyBlue text-white flex items-center gap-2 dark:bg-transparent'>
                    contact me <Image src={assets.right_arrow_white} alt='' className='w-4' /></motion.a>
                <motion.a
                    initial={{ y: 30, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    transition={{ duration: 0.6, delay: 1.2 }}
                    href="/CV_Kacper_Pudelko.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 bg-white dark:text-black'>
